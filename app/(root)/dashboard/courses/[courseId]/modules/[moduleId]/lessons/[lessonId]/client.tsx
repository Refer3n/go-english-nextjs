...
export function LessonClient({
  ...
  const navigateToLesson = useCallback(
    (lesson: Lesson) => {
      setIsLoading(true)
      startTransition(() => {
        router.push(`/courses/${courseId}/modules/${moduleId}/lessons/${lesson.id}`, { scroll: false })
      })
    },
    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 relative">
      ...
      <div className="lg:col-span-2">
        <h1 className="text-2xl font-bold mb-4">
          Module {module.order}: {lesson.title}
        </h1>
        ...
        <div className="mb-4">
          ...
          <div className="flex items-center mt-2">
            ...
            <span className="ml-2 text-sm text-light-300">{moduleProgress}% complete</span>
          </div>
        </div>
