...
export function CourseDetailsClient({ courseDetails }: CourseDetailsClientProps) {
  ...
  const addToBasket = async (redirectToBasket = false) => {
    ...
    console.log("Calling:", `/Basket/Add/${id}`)
        ...
        <div className="md:flex-1  max-w-5xl">
          <div className="flex flex-col md:flex-row gap-8">
            ...
            <div className="w-auto max-w-lg">
              ...
              <p className="text-lg mb-4">Boost your {title} Fluency</p>

              <p className="mb-6 max-w-[480px]">
                This course consists of {modulesCount} modules designed to guide learners towards achieving a {level}{" "}
              ...
              <div className="mt-6">
                ...
                >
                  {isDescriptionExpanded ? (
                    ...
                    <>
                      Full course description <ChevronDown className="h-4 w-4" />
                    </>
                  )}
                </Button>
              </div>
          ...
          <Card className="sticky top-6 w-full">
            <CardContent className="p-6 space-y-6">
              ...
              <div className="text-center text-sm text-gray-500">
                <Link className="link-text" href="/money-return">30-Day Money-Back Guarantee</Link>
      ...
      <div className="mt-16">
        ...
        <div className="flex items-center gap-4 mb-6">
          <div className="flex flex-row items-center gap-2">
            ...
            <p className="text-sm text-gray-500 mt-1">{feedbacksNumber} reviews</p>
          </div>
        </div>
        ...
        {isLoadingFeedbacks ? (
          ...
          <div className="text-center py-8 text-gray-500">No reviews yet for this course.</div>
        ) : (
          <>
